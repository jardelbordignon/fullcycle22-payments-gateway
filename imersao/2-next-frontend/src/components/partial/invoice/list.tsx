...
import { listInvoiceServerAction } from "@/lib/server-actions/invoice/list";

export async function InvoiceList() {
  const invoices = await listInvoiceServerAction();
  ...
  return (
    <div className="bg-[#1e293b] rounded-lg p-6 border border-gray-800">
      ...
      {/* Filtros */}
      {/* <div className="bg-[#232f43] rounded-lg mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>

...
import { loginServerAction } from "@/lib/server-actions/login/authentication";

export function AuthForm() {
  
  return (
    <form className="space-y-4 px-4" action={loginServerAction}>
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <Input
            ...
            className="bg-[#2a3749] border-gray-700 text-white placeholder-gray-400 p-2"
            name="apiKey"
          />
          <Button
            type="submit"
